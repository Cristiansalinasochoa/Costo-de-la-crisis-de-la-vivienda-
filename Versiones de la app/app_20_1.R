...
.punto-li-sn{display:flex;gap:0;padding:10px 0;border-bottom:0.5px solid #f0edf9;align-items:flex-start;}
.punto-li-sn:last-of-type{border-bottom:none;}
...
server <- function(input, output, session) {
  ...
  observeEvent(input$sit_elegida, {
    ...
    session$sendCustomMessage("set_inv_mig", "none")
    session$sendCustomMessage("set_inv_nna", "none")
  })
