...
tab_eje1 <- bslib::nav_panel(
  ...
  tab_wrap(
    ...
    div(class = "dim-block",
      div(class = "dim-top",
        div(h3(class = "dim-titulo", "El plan más ambicioso en décadas todavía no alcanza."),
            p(class = "dim-hook", "76.004 hogares en campamentos eran el compromiso. A mayo de 2025, el avance era del 27%.")),
    ...
    div(class = "eje-cierre",
      ...
      p(class = "eje-cierre-txt", "El Estado reconoció el problema y destinó más recursos cada año durante catorce años. Incluso el plan de vivienda más ambicioso en décadas apenas avanzó un 27% de su compromiso con los campamentos. Los campamentos son el único componente del déficit habitacional que no baja."),
    ...
    div(class = "dim-block",
      div(class = "dim-top",
        div(h3(class = "dim-titulo", "Informalidad laboral"),
            p(class = "dim-hook", "Casi todos trabajan. Pero la informalidad bloquea justo lo que se necesita para salir: el ahorro.")),
    ...
    div(class = "dim-block",
      div(class = "dim-top",
        div(h3(class = "dim-titulo", "Acceso a servicios de salud"),
            p(class = "dim-hook", "Cuando la emergencia llega, el sistema de salud no siempre puede responder.")),
    ...
    div(class = "dim-block",
      div(class = "dim-top",
        div(h3(class = "dim-titulo", "Rezago educativo"),
            p(class = "dim-hook", "Una infancia sin estabilidad casi siempre termina en rezago escolar.")),
    ...
    div(class = "dim-block",
      div(class = "dim-top",
        div(h3(class = "dim-titulo", "Inseguridad alimentaria"),
            p(class = "dim-hook", "La falta de ingresos no solo se siente en la vivienda. También llega a la mesa y al colegio.")),
    ...
    div(class = "dim-block",
      div(class = "dim-top",
        div(h3(class = "dim-titulo", "Barreras de salida"),
            p(class = "dim-hook", "Esperar no es avanzar. Para muchas familias, el sistema mismo es la barrera.")),
